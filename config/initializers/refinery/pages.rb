...
Refinery::Pages.configure do |config|
  ...
  config.add_whitelist_elements = ["source", "track", "iframe", "script", "style"]

  Loofah::HTML5::WhiteList::ALLOWED_CSS_PROPERTIES.merge %w(position background background-image left list-style min-width top z-index)
  ...
  config.add_whitelist_attributes = ["kind", "srclang", "placeholder", "controls", "required", "download"]
end
